...
function number(o) {
    ...
    if (isInteger && o >= 0 && o < 256) {
        return {
            t: 97,
            v: o
        };
    }
    if (isInteger && o >= -134217728 && o <= 134217727) {
        return {
            t: 98,
            v: o
        };
...
function bin(o) {
    return {
        t: 109,
        v: o instanceof ArrayBuffer ? new Uint8Array(o) : o instanceof Uint8Array ? o : utf8_enc(o)
    };
}
...
function en_98(o) {
    return [98, o.v >>> 24, (o.v >>> 16) & 255, (o.v >>> 8) & 255, o.v & 255];
}
...
function en_115(o) {
    return [115, o.v.length, ar(o)];
}

function en_119(o) {
    return [119, ar(o).length, ar(o)];
}

function en_118(o) {
    return [118, ar(o).length >>> 8, ar(o).length & 255, ar(o)];
}

function en_100(o) {
    return [100, o.v.length >>> 8, o.v.length & 255, ar(o)];
}

function en_107(o) {
    return [107, o.v.length >>> 8, o.v.length & 255, ar(o)];
}
...
function en_110(o) {
    ...
    return [110, s.length, (o.v < 0) ? 1 : 0].concat(s);
}
...
function arr(b) {
    var dv, sz = sx.getUint16(ix);
    ix += b;
    return new Uint8Array(sx.buffer.slice(ix, ix += sz));
}

function ref(cr) {
    var adj = sx.getUint8(ix++),
        d;
    adj += sx.getUint8(ix++);
    d = din();
    ix += cr + adj * 4;
